...
public class TransferController {
    ...
    //@TODO have server throw exceptions in addition to client
    //@TODO general authentication stuff and security
    ...
    //@TODO can look up account to ID based on principal
